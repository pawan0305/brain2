...
[![Download installer](https://img.shields.io/badge/Download-OneTrueDutchie_0.5.1_x64--setup.exe-0078d4?style=for-the-badge&logo=windows)](https://github.com/pawan0305/onetruedutchie-windows/releases/download/v0.5.1/OneTrueDutchie_0.5.1_x64-setup.exe)
...
→ **[OneTrueDutchie_0.5.1_x64-setup.exe](https://github.com/pawan0305/onetruedutchie-windows/releases/download/v0.5.1/OneTrueDutchie_0.5.1_x64-setup.exe)** — NSIS installer (~3.4 MB · per-user · no admin prompt · adds a Start-menu entry)

Prefer no install? Grab the standalone **[OneTrueDutchie_0.5.1_x64-portable.exe](https://github.com/pawan0305/onetruedutchie-windows/releases/download/v0.5.1/OneTrueDutchie_0.5.1_x64-portable.exe)** (~15 MB) and just run it.
