...
| Download | What it is |
|---|---|
| [**Brain2-0.6.1-portable-x64.exe**](https://github.com/pawan0305/brain2/releases/download/v0.6.1/Brain2-0.6.1-portable-x64.exe) | **Portable single .exe** — just run it, no install (~70 MB; bundles on-device Whisper STT). |
| [Brain2_0.6.1_x64-setup.exe](https://github.com/pawan0305/brain2/releases/download/v0.6.1/Brain2_0.6.1_x64-setup.exe) | NSIS installer (~9 MB). |
