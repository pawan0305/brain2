...
| Download | What it is |
|---|---|
| [**Brain2-0.6.4-portable-x64.exe**](https://github.com/pawan0305/brain2/releases/download/v0.6.4/Brain2-0.6.4-portable-x64.exe) | **Portable single .exe** — just run it, no install (~70 MB; bundles on-device Whisper STT). |
| [Brain2_0.6.4_x64-setup.exe](https://github.com/pawan0305/brain2/releases/download/v0.6.4/Brain2_0.6.4_x64-setup.exe) | NSIS installer (~9 MB). |

v0.6.4 is a production-readiness pass: no console-window flashing, better local transcription, Forge removed, fixed settings storage, Windows-native fonts. See the [release notes](https://github.com/pawan0305/brain2/releases/tag/v0.6.4).
